...
public class ClicksProducer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Specify Topic
        String clickTopic = "click-events";
        String gazeTopic = "gaze-events";
        ...
        deleteTopic(clickTopic, properties);
        deleteTopic(gazeTopic, properties);

        // create new topic with 1 partition
        createTopic(clickTopic, 1, properties);
        createTopic(gazeTopic, 1, properties);
